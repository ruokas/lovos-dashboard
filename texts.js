...
export const texts = {
  ...
  tasks: {
    ...
    labels: {
      ...
      patient: { lt: 'Pacientas', en: 'Patient' },
      chart: { lt: 'Kortelė', en: 'Chart' },
      patientUnknown: { lt: 'nenurodyta', en: 'not provided' },
      chartUnknown: { lt: 'nenurodyta', en: 'not provided' },
  ...
  forms: {
    ...
    task: {
      ...
      patientSurnameLabel: { lt: 'Paciento pavardė', en: 'Patient surname' },
      patientSurnamePlaceholder: { lt: 'Pvz., Petraitis', en: 'e.g. Doe' },
      patientChartLabel: { lt: 'Kortelės Nr.', en: 'Chart number' },
      patientChartPlaceholder: { lt: 'Pvz., A12345', en: 'e.g. A12345' },
